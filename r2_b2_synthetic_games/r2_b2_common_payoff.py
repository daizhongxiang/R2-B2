'''
This script runs the R2-B2 algorithm for two-agent common-payoff games using synthetic payoff functions
'''
...
log_directory = "results_common_payoff_" + level_zero_policy
